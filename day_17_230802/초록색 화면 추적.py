...
cv2.createTrackbar("HUE Min", "HSV", 50, 70, empty)  # 보라색 색상 범위: 약 130~160
cv2.createTrackbar("HUE Max", "HSV", 160, 179, empty)
cv2.createTrackbar("SAT Min", "HSV", 50, 255, empty)  # 채도와 명도는 알려진 범위를 기준으로 조정
...
def startvideo():
    ...
    while True:
        ...
        cv2.imshow('Laptop Camera Stream', stack)
